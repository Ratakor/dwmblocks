...
static const Block blocks[] = {
    ...
    //{"",      "$XDG_CONFIG_HOME/dwmblocks/modules/sb_ethernet",      10,                    0},
    //{"",      "$XDG_CONFIG_HOME/dwmblocks/modules/sb_localip",       10,                    0},
    //{"",      "$XDG_CONFIG_HOME/dwmblocks/modules/sb_publicip",      10,                    0},
    ...
    {"",      "$XDG_CONFIG_HOME/dwmblocks/modules/sb_weather",       18000,                 0},
